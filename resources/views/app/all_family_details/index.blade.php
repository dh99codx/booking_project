                        ...
                        <tr>
                            ...
                            <td class="text-center" style="width: 134px;">
                                ...
                                >
                                    ...
                                    @endcan @can('view', $familyDetails)
                                    <a
                                        href="{{ route('all-family-details.show', $familyDetails) }}"
                                    >
                                        <button
                                            type="button"
                                            class="btn btn-light"
                                    ...
                                    @endcan @can('delete', $familyDetails)
                                    <form
                                        action="{{ route('all-family-details.destroy', $familyDetails) }}"
                                        method="POST"
