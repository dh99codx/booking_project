            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="given_name" class="col-md-4 col-form-label text-md-end">{{ __('Given Name') }}</label>
                        ...
                        <div class="form-check">
                            <input type="checkbox"  name="news_letter_subscription" class="form-check-input" id="news_letter_subscription">
                            <label class="form-check-label" for="exampleCheck1">News Letter Subscription</label>
                        </div>
                        </div>
